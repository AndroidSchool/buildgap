...
(function () {
  ...
  angular.module('ui.tree')
    ...
    .controller('TreeNodeController', ['$scope', '$rootScope','$element', '$attrs', 'treeConfig',
      function ($scope, $rootScope,$element, $attrs, treeConfig) {
        this.scope = $scope;
        ...
        $scope.activate = function(widget_id){
          alert(widget_id);
        ...
        return {
          ...
          link: function(scope, element, attrs, controllersArr) {
            ...
            var dragStart = function(e) {
              ...
              if(eventElm.attr("data-drag-hack") !== 'true'){
                return;
              }
              ...
              //console.log(eventScope.$type);
              //console.log(eventScope.$handleScope);
